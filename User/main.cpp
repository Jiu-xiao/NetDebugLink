...
extern "C" void app_main(void) {
  ...
  LibXR::ESP32VirtualUART<2048> uart_cdc(20, 4, 2048, 4, 2048);

  LibXR::ESP32UART uart_1(UART_NUM_0, 3, 4, 256, 2048, 4);

  LibXR::ESP32UART uart_2(UART_NUM_1, 5, 6, 256, 2048, 4);
